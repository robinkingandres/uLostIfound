          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="relative">
              <select 
                ...
                className="w-full pl-4 pr-10 py-3 bg-slate-50 border-none rounded-xl text-sm text-slate-700 appearance-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            return (
              ...
              >
                ...
                <div className="relative h-56 w-full bg-slate-200 overflow-hidden">
                  <img src={report.image} alt={report.itemName} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
...
<div className="mt-auto pt-5 border-t border-slate-50 flex items-center justify-between">
  <div className="flex items-center gap-2">
    {/* The icon and the dynamic name of the reporter */}
    <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-blue-500 border border-blue-100">
      <UserIcon className="w-4 h-4" />
    </div>
    <span className="text-xs font-bold text-slate-700 uppercase tracking-tight line-clamp-1">
      {/* This renders the name of the user who created the report */}
      {report.reporter}
    </span>
  </div>
...
<div className="fixed bottom-6 right-6 z-50">
  ...
  >
    ...
    {/* Notification Dot - Positioned relative to the logo edge */}
    {hasChatNotification && (
